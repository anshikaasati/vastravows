...
const CartPage = () => {
    ...
    if (cart.length === 0) {
        return (
            ...
            >
                ...
                <div className="relative z-10 bg-white p-8 sm:p-12 rounded-xl shadow-xl border border-gray-100 max-w-lg w-full mx-4">
    ...
    return (
        <div className="min-h-screen bg-[#fcf8f9] py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-3xl sm:text-5xl md:text-7xl font-script text-primary/90 mb-8 sm:mb-12 text-center md:text-left">Shopping Cart</h1>

                <div className="grid lg:grid-cols-[1fr_400px] gap-6 sm:gap-8">
                    {/* Cart Items */}
                    <div className="space-y-4 sm:space-y-6">
                        {cart.map((item, index) => (
                            <div key={`${item._id}-${item.selectedSize}-${index}`} className="bg-white p-5 sm:p-6 md:p-8 rounded-xl border border-gray-100 flex flex-col md:flex-row gap-4 sm:gap-6 hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300">
                                ...
                                <div className="flex-1 flex flex-col">
                                    <div className="flex justify-between items-start mb-3 sm:mb-4">
                                        <div className="space-y-2 flex-1">
                                            <h3 className="text-lg sm:text-xl md:text-2xl font-display font-medium text-gray-900 pr-2">{item.title}</h3>
                                        ...
                                        <button
                                            ...
                                            className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl border border-gray-200 flex items-center justify-center text-gray-400 hover:text-red-600 hover:border-red-200 hover:bg-red-50 transition-all flex-shrink-0"
                                            title="Remove Item"
                                        >
                                    ...
                                    <div className="mt-auto pt-6 border-t border-gray-50 flex justify-between items-end">
                                        ...
                                        <div>
                                            {item.salePrice ? (
                                                <p className="text-2xl sm:text-3xl font-display font-medium text-primary">₹{item.salePrice}</p>
                                            ) : (
                                                <div className="text-right">
                                                    <p className="text-2xl sm:text-3xl font-display font-medium text-primary">
                    ...
                    <div className="h-fit space-y-6">
                        <div className="bg-white p-6 sm:p-8 rounded-xl shadow-xl border border-gray-100 lg:sticky lg:top-24">
                            ...
                            <button
                                ...
                                className="w-full py-3.5 sm:py-4 bg-gradient-to-r from-[#d48496] to-[#760a1e] text-white font-bold uppercase tracking-widest text-xs rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-3"
                            >
                                Proceed to Checkout
